...
const proyectos = [{
  titulo: "BLOG CAFE",
  ruta: "src/assets/img/BlogCafe.png",
  ...
  ruta: "src/assets/img/Encriptador.png",
  ...
  titulo: "DEPORTES JS",
  ruta: "src/assets/img/deporteJS.png",
  ...
  titulo: "FORMULA 1",
  ruta: "src/assets/img/Formula1.png",
  ...
  ruta: "src/assets/img/EarthVolunteers.png",
  ...
  ruta: "src/assets/img/ContadorYCalculadora.png",
                ...
                <div className={styles.links}>
                  {view !== null && (
                    <a className={styles.linkstarget} href={view} target="_blank" rel="noopener noreferrer">
                      <img src="src/assets/icons/view.svg" width={40} height={40} title="Ir a ver" alt="View" />
                    </a>
                  )}
                  <a className={styles.linkstarget} href={github} target="_blank" rel="noopener noreferrer">
                    <img src="src/assets/icons/whitegithub.svg" width={40} height={40} title="Repositorio" alt="Repositorio" />
                  </a>
                </div>
              </div>
            </div>
